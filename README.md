...
5) ngSubmit - event to which you can listen on form element, which will occur when form submittion happened and that browser default was prevented. Then you can run your own code in response to this ngSubmit event `<form (ngSubmit)="onSubmit()">`
